...
const Homepage: NextPage = () => {
  return (
    <div className="relative bg-white w-full h-[241.31rem] overflow-hidden text-left text-[1.44rem] text-hotpink font-nunito-sans">
      ...
      <div className="absolute top-[0rem] left-[calc(50%_-_720px)] w-[90rem] flex flex-row py-[2rem] px-[10.31rem] box-border items-center justify-between text-[0.88rem] text-black">
      ...
      <div className="absolute top-[11.06rem] left-[calc(50%_-_555px)] flex flex-row items-center justify-start text-[0.88rem]">
